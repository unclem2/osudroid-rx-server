...
async def whitelist_add(
    ...
    if status in (RankedStatus.Blacklisted, RankedStatus.WIP, RankedStatus.Pending, RankedStatus.Qualified):
        return ApiResponse.bad_request("Cannot be ranked, not meeting RankedStatus requirements.")
    ...
    await beatmap_service.change_ranked_status(beatmap, RankedStatus.Whitelisted)
