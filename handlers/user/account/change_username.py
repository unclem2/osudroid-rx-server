...
async def change_username():
    ...
    if request.method == "POST":
        ...
        await glob.db.execute(
            "UPDATE users SET username = $1, username_safe = $2 WHERE id = $3", [new_username, safe_username, player.id]
        )
        return render_template("success.jinja", success_message="Username changed successfully")