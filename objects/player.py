...
class Player:
    def __init__(self, **kwargs):
        ...
        #
        self.email_hash: str = kwargs.get('email_hash',
                                          '35da3c1a5130111d0e3a5f353389b476')  # used for gravatar, default to my pfp lole
    ...
    async def from_sql(cls, user_id: int):
        user_data = await glob.db.fetch("SELECT id, prefix, username, email_hash, email FROM users WHERE id = $1",
                                        [int(user_id)])
